...
export function gameEventTypeFromJSON(object: any): GameEventType {
  switch (object) {
    case 0:
    case "INVALID_EVENT":
      return GameEventType.INVALID_EVENT;
    case 1:
    case "CHEST_OPENED":
      return GameEventType.CHEST_OPENED;
    case 2:
    case "PLAYER_MOVED":
      return GameEventType.PLAYER_MOVED;
    case 3:
    case "DOOR_OPENED":
      return GameEventType.DOOR_OPENED;
    case 4:
    case "DOOR_CLOSED":
      return GameEventType.DOOR_CLOSED;
    case 5:
    case "PRESSURE_PLATE_ACTIVATED":
      return GameEventType.PRESSURE_PLATE_ACTIVATED;
    case 6:
    case "PRESSURE_PLATE_DEACTIVATED":
      return GameEventType.PRESSURE_PLATE_DEACTIVATED;
    case 7:
    case "BLOCK_DAMAGED":
      return GameEventType.BLOCK_DAMAGED;
    case 8:
    case "BLOCK_MINED":
      return GameEventType.BLOCK_MINED;
    case -1:
    case "UNRECOGNIZED":
    default:
      return GameEventType.UNRECOGNIZED;
  }
}

export function gameEventTypeToJSON(object: GameEventType): string {
  switch (object) {
    case GameEventType.INVALID_EVENT:
      return "INVALID_EVENT";
    case GameEventType.CHEST_OPENED:
      return "CHEST_OPENED";
    case GameEventType.PLAYER_MOVED:
      return "PLAYER_MOVED";
    case GameEventType.DOOR_OPENED:
      return "DOOR_OPENED";
    case GameEventType.DOOR_CLOSED:
      return "DOOR_CLOSED";
    case GameEventType.PRESSURE_PLATE_ACTIVATED:
      return "PRESSURE_PLATE_ACTIVATED";
    case GameEventType.PRESSURE_PLATE_DEACTIVATED:
      return "PRESSURE_PLATE_DEACTIVATED";
    case GameEventType.BLOCK_DAMAGED:
      return "BLOCK_DAMAGED";
    case GameEventType.BLOCK_MINED:
      return "BLOCK_MINED";
    case GameEventType.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
function createBaseDoor(): Door {
  return { isOpen: false, woodType: 0, direction: 0 };
}
...
export const CellType_ChestCell = {
  encode(message: CellType_ChestCell, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.isOpened !== false) {
      writer.uint32(16).bool(message.isOpened);
    }
    return writer;
  },
  ...
  fromJSON(object: any): CellType_ChestCell {
    return {
      ...
      isOpened: isSet(object.isOpened) ? globalThis.Boolean(object.isOpened) : false,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CellType_ChestCell>, I>>(object: I): CellType_ChestCell {
    ...
    message.isOpened = object.isOpened ?? false;
    return message;
  },
};
...
function createBaseGameEvent(): GameEvent {
  return { eventType: 0, position: undefined, player: 0, woodType: 0 };
}
...
export const GameEvent = {
  encode(message: GameEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.woodType !== 0) {
      writer.uint32(32).int32(message.woodType);
    }
    return writer;
  },
  ...
  fromJSON(object: any): GameEvent {
    return {
      eventType: isSet(object.eventType) ? gameEventTypeFromJSON(object.eventType) : 0,
      position: isSet(object.position) ? Coordinates.fromJSON(object.position) : undefined,
      player: isSet(object.player) ? playerFromJSON(object.player) : 0,
      woodType: isSet(object.woodType) ? woodTypeFromJSON(object.woodType) : 0,
    };
  ...
  toJSON(message: GameEvent): unknown {
    const obj: any = {};
    if (message.eventType !== 0) {
      obj.eventType = gameEventTypeToJSON(message.eventType);
    }
    if (message.position !== undefined) {
      obj.position = Coordinates.toJSON(message.position);
    }
